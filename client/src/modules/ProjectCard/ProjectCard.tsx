...
import {projectDefaultValues, projectSchema, projectSchemaType} from '../../shared/validations/projectSchema.ts'
...
export const ProjectCard: FC<Props> = ({editMode}) => {
	...
	return (
		<div className={styles.projectCard}>
			...
			<button className={styles.closeBtn} onClick={() => dispatch(uiActions.resetState())}>
				<Icon iconType='close' />
			</button>
		</div>
	)
